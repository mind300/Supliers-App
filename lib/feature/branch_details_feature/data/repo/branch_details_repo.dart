...
abstract class BranchDetailsRepo {
  ...
  Future<Either<CustomException, CashierModel>> getAllCashiersThatWithoutBranch();
...
class BranchDetailsImpl extends BranchDetailsRepo {
  ...
  @override
  Future<Either<CustomException, CashierModel>> getAllCashiersThatWithoutBranch() async {
    try {
      Response res = await dioHelper.get(
        endPoint: EndPoints.getAllCashiersThatWithoutBranch,
      );
      if (res.statusCode == 200) {
